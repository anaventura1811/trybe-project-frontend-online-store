...
Projeto desenvolvido como requisito parcial para conclusão do módulo de desenvolvimento front-end do curso de Desenvolvimento Web da Trybe. Desenvolvido em grupo, este projeto tem como objetivo principal aplicar conceitos metodologias ágeis no desenvolvimento de software. Nesta aplicação, foi criada uma versão simplificada, sem persistência no banco de dados, de uma **loja online**, desenvolvendo em grupo as funcionalidades, conforme demandas definidas em quadro _Kanban_. A ideia era aproximar o processo de desenvolvimento ao cenário mais fiel possível do cotidiano de uma squad no mercado de trabalho. A partir das demandas, temos então uma aplicação na qual os usuários podem:

- Buscar produtos por termos e categorias a partir da _API do Mercado Livre_;
- Interagir com os produtos buscados: ações de adição ao carrinho, alteração de quantidade de produto adicionado ou remoção de produto do carrinho de compras;
- Visualizar os detalhes e avaliações prévias de um produto, bem como criar novas avaliações;
- E, por fim, a simulação do fluxo de checkout dos itens selecionados adicionados ao carrinho.
